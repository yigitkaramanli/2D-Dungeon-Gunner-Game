...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("Populate with the TextMeshPro-Text compınent on the child WeaponNameText gameobject.")]
    #endregion
    [SerializeField]
    private TextMeshProUGUI weaponNameText;

    #region Tooltip
    [Tooltip("Populate with the RectTransform of the child ReloadBar gameobject.")]
    #endregion
    [SerializeField]
    private Transform reloadBar;
    
    #region Tooltip
    [Tooltip("Populate with the Image component of the child BarImage gameobject.")]
    #endregion
    [SerializeField]
