...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip(
        "Populate with the prefab to be used for the ammo. " +
    ...
    #region Tooltip
    [Tooltip(
        "Minimum spawn interval time. The time interval in seconds between spawned ammo is a random value between the min and the max values specified.")]
    #endregion
    public float ammoSpawnIntervalMin = 0f;
    
    #region Tooltip
    [Tooltip(
        "Maximum spawn interval time. The time interval in seconds between spawned ammo is a random value between the min and the max values specified.")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("Selected if an ammo trail is required, otherwise deselect." +
             "If selected then the rest of the ammo trail values should be populated.")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("Ammo trail starting width.")]
    #endregion
    [Range(0f, 1f)]
    public float ammoTrailStartWidth;
    
    #region Tooltip
    [Tooltip("Ammo trail ending width")]
    #endregion
    [Range(0f, 1f)]
