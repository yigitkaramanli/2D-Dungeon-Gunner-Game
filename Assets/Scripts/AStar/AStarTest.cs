...
public class AStarTest : MonoBehaviour
{
    ...
    {
        if (position.x < instantiatedRoom.room.roomTemplateLowerBounds.x ||
            position.x > instantiatedRoom.room.roomTemplateUpperBounds.x ||
            position.y < instantiatedRoom.room.roomTemplateLowerBounds.y ||
            position.y > instantiatedRoom.room.roomTemplateUpperBounds.y)
        {
            return false;
        }
        else
